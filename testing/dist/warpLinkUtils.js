...
exports.createWarpLink = createWarpLink;
exports.createTippingLink = createTippingLink;
exports.createTippingLinks = createTippingLinks;
/**
 ...
 */
function getBaseWarpUrl(env = "devnet") {
    switch (env) {
        case "devnet":
 ...
 */
function createWarpLink(txHash, queryParams = {}, env = "devnet") {
 ...
 */
function createTippingLink(txHash, recipientAddress, network = "devnet") {
 ...
 */
function createTippingLinks(txHash, recipients, env = "devnet") {
    const links = {};
