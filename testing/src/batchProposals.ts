 ...
 */
async function createProposalsFromFile(
  filePath: string,
  contractAddress: string = "erd1qqqqqqqqqqqqqpgqd2grsvwg8vln8msqe4ry7k8w63388pl2ldvsq5xpkt",
  ...
  try {
    ...
    results
      ...
      .forEach((r) =>
        console.log(`- ${r.description.substring(0, 30)}...: ${r.txHash}`)
      );
    ...
    await fs.writeFile(
      `proposal-results-${Date.now()}.json`,
...
export { createProposalsFromFile };
